...
def generate_feature_graph(file_path, x, y):
    ...
    # Generate the chart and set the design
...
def getdata():
    ...
    # Get the artist and track name from the input form 
    ...
    # Use the search function of the spotify API to obtain the track ID from the artist and track name
    ...
    # Reformat Variables for Social media prediction
    key_A = 0
    key_A__Bb = 0
    key_B = 0
    key_C = 0
...
##### Recommendation Feature Tuning #####
    ...
    for feature in tuningfeatures: 
        for value in values:
            ...
            # Check if the prediction is a HIT or FLOP
